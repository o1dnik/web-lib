    ...
    case _constants.ALERT + _constants.SHOW:
      {
        var _payload$notification = payload.notification,
            ...
            _type = _payload$notification.type,
            dismissAfter = _payload$notification.dismissAfter,
            _action = _payload$notification.action,
            _payload$notification2 = _payload$notification.hideOnRouteChange,
            hideOnRouteChange = _payload$notification2 === undefined ? true : _payload$notification2;
