...
exports.default = function () {
  ...
  switch (type) {
    ...
    case (0, _utils.getActionType)(_constants.ME, _constants.GET, _constants.SUCCESS):
      {
        var locations = (0, _get3.default)(res, "data.locations");

        if (locations && locations.length > 0) {
          return _extends({}, state, {
            entities: (0, _unionBy3.default)(state.entities, locations, "id")
          });
        }
    ...
    case (0, _utils.getActionType)(_constants.ME, _constants.BACKGROUND, _constants.GET, _constants.SUCCESS):
      {
        var _locations = (0, _get3.default)(res, "data.locations");

        if (_locations && _locations.length > 0) {
          return _extends({}, state, {
            entities: (0, _unionBy3.default)(state.entities, _locations, "id")
          });
        }
