...
exports.default = function () {
  ...
  switch (type) {
    ...
    case _constants.SKILLS + _constants.GET + _constants.START:
      {
        return _extends({}, state, { loading: true });
      }

    case _constants.SKILLS + _constants.GET + _constants.SUCCESS:
      {
    ...
    case _constants.SKILLS + _constants.GET + _constants.FAIL:
      {
    ...
    case _constants.JOB + _constants.GET + _constants.SUCCESS:
      {
        ...
        return _extends({}, state, {
          entities: (0, _unionBy2.default)(state.entities, skills, 'id')
        });
      }
    ...
    case _constants.ME + _constants.GET + _constants.SUCCESS:
      {
        ...
        return _extends({}, state, {
          entities: _skills ? (0, _unionBy2.default)(state.entities, _skills, 'id') : state.entities
        });
      }
