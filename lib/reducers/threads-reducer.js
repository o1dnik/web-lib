...
var actionHandlers = exports.actionHandlers = (_actionHandlers = {}, _defineProperty(_actionHandlers, (0, _utils.getActionType)(_constants.THREADS, _constants.GET, _constants.START), function (state, action) {
  return _extends({}, state, {
    loading: action.payload.showLoader ? _constants.LOADING : state.loading
  });
