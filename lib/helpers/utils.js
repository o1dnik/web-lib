...
function getAsyncActionHandler(_ref) {
  ...
  return _ref2 = {}, _defineProperty(_ref2, getActionType(type, _constants.START), function (state) {
    return _extends({}, state, _defineProperty({}, prop, _constants.LOADING));
  }), _defineProperty(_ref2, getActionType(type, _constants.SUCCESS), function (state, action) {
    var result = _extends({}, state, _defineProperty({}, prop, _constants.SUCCESS));

    if (handler) return _extends({}, result, handler(state, action));
    return result;
  }), _defineProperty(_ref2, getActionType(type + _constants.FAIL), function (state) {
    return _extends({}, state, _defineProperty({}, prop, _constants.FAIL));
  }), _ref2;
}