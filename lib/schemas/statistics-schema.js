...
exports.default = _yup2.default.object().shape({
  ...
  last_offer_at: _yup2.default.string().required().nullable(true).default(""),
  last_match_at: _yup2.default.string().required().nullable(true).default(""),
  last_activity: _yup2.default.string().required().nullable(true).default("")
}).noUnknown();
