  ...
  _createClass(Tag, [{
    ...
    value: function render() {
      ...
      var newCildren = _react.Children.map(children, function (c) {
        ...
        return _react2.default.cloneElement(c, _extends({}, c.props, { onClick: childClick }));
      });
      ...
      var css = (0, _classnames2.default)((_cn = {
        tag: true
      }, _defineProperty(_cn, withPrefix(color), Boolean(color)), _defineProperty(_cn, withPrefix(size), Boolean(size)), _defineProperty(_cn, withPrefix('bordered'), Boolean(bordered)), _defineProperty(_cn, withPrefix('clickable'), Boolean(onClick && !disabled)), _defineProperty(_cn, withPrefix('extended'), Boolean(extended)), _defineProperty(_cn, withPrefix('disabled'), Boolean(disabled)), _defineProperty(_cn, withPrefix('icon'), Boolean(hasIcon)), _cn), className);
