  ...
  _createClass(Tag, [{
    ...
    value: function render() {
      ...
      var _props = this.props,
          ...
          extra = _props.extra,
          rest = _objectWithoutProperties(_props, ["children", "onClick", "color", "size", "bordered", "extended", "apart", "disabled", "value", "className", "extra"]);
      ...
      var newCildren = _react.Children.map(children, function (c) {
        ...
        return _react2.default.cloneElement(c, _extends({}, c.props, {
          onClick: !disabled && childClick || _noop3.default,
          className: className
        }));
      });
      ...
      var css = (0, _classnames2.default)((_cn = {
        tag: true
      }, _defineProperty(_cn, withPrefix(color), Boolean(color)), _defineProperty(_cn, withPrefix(size), Boolean(size)), _defineProperty(_cn, withPrefix("bordered"), Boolean(bordered)), _defineProperty(_cn, "clickable", Boolean(onClick && !disabled)), _defineProperty(_cn, withPrefix("extended"), Boolean(extended)), _defineProperty(_cn, withPrefix("apart"), Boolean(apart)), _defineProperty(_cn, withPrefix("disabled"), Boolean(disabled)), _defineProperty(_cn, withPrefix("value"), Boolean(value)), _defineProperty(_cn, withPrefix("icon"), Boolean(hasIcon)), _defineProperty(_cn, withPrefix("extra"), Boolean(extra)), _cn), className);

      return _react2.default.createElement(
        "span",
        _extends({}, rest, { onClick: !disabled && onClick || _noop3.default, className: css }),
        newCildren
      );
    }
  }]);
