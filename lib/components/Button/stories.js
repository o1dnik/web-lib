  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      sizes.map(function (s) {
        return _react2.default.createElement(
          _index2.default,
          { key: s, size: s, onClick: (0, _storybook.action)('clicked') },
          _react2.default.createElement(
            'span',
            null,
            s
    ...
    _react2.default.createElement(
      ...
      colors.map(function (s) {
        return _react2.default.createElement(
          _index2.default,
          { key: s, color: s, onClick: (0, _storybook.action)('clicked') },
          _react2.default.createElement(
            'span',
            null,
            s
    ...
    _react2.default.createElement(
      ...
      colors.map(function (s) {
        return _react2.default.createElement(
          _index2.default,
          { key: s, outline: true, color: s, onClick: (0, _storybook.action)('clicked') },
          _react2.default.createElement(
            'span',
            null,
            s
    ...
    _react2.default.createElement(
      ...
      sizes.map(function (s) {
        return _react2.default.createElement(
          _index2.default,
          { key: s, loading: true, size: s, onClick: (0, _storybook.action)('clicked') },
          _react2.default.createElement(
            'span',
            null,
            'Loading ',
