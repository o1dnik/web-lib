  ...
  _createClass(Button, [{
    ...
    value: function render() {
      ...
      var css = (0, _classnames2.default)((_cn = {
        button: true
      }, _defineProperty(_cn, withPrefix(color), Boolean(color)), _defineProperty(_cn, withPrefix(size), Boolean(size)), _defineProperty(_cn, withPrefix('outline'), Boolean(outline)), _defineProperty(_cn, withPrefix('extended'), Boolean(extended)), _defineProperty(_cn, withPrefix('disabled'), Boolean(disabled)), _defineProperty(_cn, withPrefix('loading'), Boolean(loading)), _defineProperty(_cn, withPrefix('link'), Boolean(href || link)), _defineProperty(_cn, withPrefix('icon'), Boolean(hasIcon)), _cn), className);
      ...
      return _react2.default.createElement(
        ...
        loading && _react2.default.createElement(_Loader2.default, { size: 'xsmall' }),
        newCildren
      );
    }
  }]);
