  ...
  _createClass(AlertBar, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          rest = _objectWithoutProperties(_props, ['type', 'hideAlertBar', 'message', 'dismissAfter', 'values']);
      ...
      var messageBody = _react2.default.createElement(
        ...
        message && message.id && typeof message.id === 'string' && _react2.default.createElement(_reactIntl.FormattedMessage, _extends({}, message, { values: values })),
        (!message || !message.id) && _react2.default.createElement(
          'span',
          null,
          message
        )
...
AlertBar.propTypes = {
  ...
  dismissAfter: _propTypes2.default.oneOfType([_propTypes2.default.number, _propTypes2.default.bool]),
