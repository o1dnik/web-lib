...
AlertBar.PropTypes = {
  ...
  message: _react.PropTypes.oneOfType([_react.PropTypes.string, _react.PropTypes.element]),
  dismissAfter: _react.PropTypes.number.isRequired,
  action: _react.PropTypes.string.isRequired,
  hideAlertBar: _react.PropTypes.func.isRequired,
  hideOnRouteChange: _react.PropTypes.bool.isRequired
};
