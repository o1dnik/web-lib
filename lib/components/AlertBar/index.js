  ...
  _createClass(AlertBar, [{
    ...
    value: function render() {
      ...
      var messageBody = _react2.default.createElement(
        ...
        message && typeof message === 'string' && _react2.default.createElement(_reactIntl.FormattedMessage, { id: message, values: values }),
        (!message || typeof message !== 'string') && _react2.default.createElement(
          'span',
          null,
          message
        )
