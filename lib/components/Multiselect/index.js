...
var Multiselect = function (_Component) {
  ...
  function Multiselect(props) {
    ...
    _this.onTagAdd = function (updVal) {
      ...
      var newVal = (0, _unionBy2.default)(oldVal, updVal, 'value'); // multi => arrays merge
        ...
        _react2.default.createElement(
          ...
          value.map(function (v) {
            return _react2.default.createElement(
              ...
              v.label,
              _react2.default.createElement('i', { className: 'mb-ico-cross',
                onClick: !disabled && _this2.onTagRemove(v) })
            );
          })
        ),
        _react2.default.createElement(
...
Multiselect.propTypes = {
  ...
  autoBlur: _react.PropTypes.bool,
