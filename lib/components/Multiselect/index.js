...
var Multiselect = function (_Component) {
  ...
  function Multiselect() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Multiselect.__proto__ || Object.getPrototypeOf(Multiselect)).call.apply(_ref, [this].concat(args))), _this), _this.onBlur = function (e) {
    ...
    }, _this.onValueAdd = function (updVal) {
      ...
      // multi => arrays merge
      var newValues = (0, _unionBy2.default)(oldVal, updVal, 'value');

      if (onChange) return onChange(newValues);
      if (input.onChange) input.onChange(newValues);
    }, _this.onValueRemove = function (tag) {
      return function (e) {
          ...
          value.map(function (v) {
            return _react2.default.createElement(
              ...
              _react2.default.createElement('i', {
                className: 'ion-close',
                onClick: _this2.onValueRemove(v)
              })
            );
          })
        ),
