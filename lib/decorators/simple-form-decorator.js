  ...
  return function (Component) {
    ...
    return _temp2 = _class = function (_React$Component) {
      ...
      function SimpleFormDecorator() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = SimpleFormDecorator.__proto__ || Object.getPrototypeOf(SimpleFormDecorator)).call.apply(_ref, [this].concat(args))), _this), _this.state = {
          initialValues: _extends({}, _this.props.initialValues),
          values: _extends({}, _this.props.initialValues),
          dirty: _mapValues(_this.props.initialValues, function () {
            return false;
          }),
          touched: _mapValues(_this.props.initialValues, function () {
            return false;
          }),
          errors: _mapValues(_this.props.initialValues, function () {
            return null;
          }),
          isDirty: false,
          isTouched: false,
          ...
          if (_has(validators, name) && Array.isArray(validators[name])) {
          ...
          _this.setState(function (prevState) {
            return {
              ...
              dirty: _mapValues(prevState.initialValues, function () {
                return false;
              }),
              errors: _mapValues(prevState.initialValues, function () {
                return null;
              }),
              touched: _mapValues(prevState.initialValues, function () {
                return false;
              }),
              isDirty: false,
              isTouched: false,
          ...
          _this.setState(function (prevState) {
            return {
              ...
              dirty: _mapValues(Object.assign({}, values || prevState.values), function () {
                return false;
              }),
              errors: _mapValues(Object.assign({}, values || prevState.values), function () {
                return null;
              }),
              touched: _mapValues(Object.assign({}, values || prevState.values), function () {
                return false;
              }),
