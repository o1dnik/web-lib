...
var ProfileRequired = function ProfileRequired(_ref) {
  ...
  return _react2.default.createElement(_reactRouterDom.Route, _extends({}, rest, { render: function render(props) {
      if (!isLogged) {
        var redirectTo = (0, _get3.default)(rest, 'location.pathname', '/');

        var fullSearch = '?redirectTo=' + redirectTo;

        var search = (0, _get3.default)(rest, 'location.search', '?').substring(1);
      ...
      if (!profileComplete) {
        var _search = (0, _get3.default)(rest, 'location.search', '');
