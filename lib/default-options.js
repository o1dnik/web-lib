...
var REJECTION_REASONS = exports.REJECTION_REASONS = [{ id: '1', name: 'Not responding' }, { id: '2', name: 'Qualification' }, { id: '3', name: 'Cultural fit' }, { id: '3', name: 'Salary expectation' }, { id: '0', name: 'Other' }];
