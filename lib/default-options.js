...
var CAREER_LEVELS = exports.CAREER_LEVELS = [{ id: '0', name: 'Student' }, { id: '1', name: 'Entry level' }, { id: '2', name: 'Intermediate' }, { id: '3', name: 'Senior' }, { id: '4', name: 'Lead' }, { id: '5', name: 'Executive' }];
