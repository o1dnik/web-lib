...
var CAREER_LEVELS = exports.CAREER_LEVELS = [{ value: '0', label: 'Student' }, { value: '1', label: 'Entry level' }, { value: '2', label: 'Intermediate' }, { value: '3', label: 'Senior' }, { value: '4', label: 'Lead' }, { value: '5', label: 'Head' }, { value: '6', label: 'Executive' }];
