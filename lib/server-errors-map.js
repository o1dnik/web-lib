...
var serverErrorsMap = {
  ...
  wrong_credentials: function wrong_credentials(action) {
    return _react2.default.createElement(
      'span',
      null,
      'Forgot your password? Please\xA0',
      _react2.default.createElement(
        _reactRouterDom.Link,
        { className: 'underlined-link', to: { pathname: '/password-recovery', state: { email: action.email } } },
        'click here'
      ),
      '\xA0to recover.'
    );
  ...
  token_invalid: _react2.default.createElement(
    'span',
    null,
    'Sorry, but this code is expired or invalid.\xA0',
    _react2.default.createElement(
      _reactRouterDom.Link,
      { to: '/resend' },
