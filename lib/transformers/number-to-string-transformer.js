...
exports.default = function (res) {
  res.data = changeNumberToStringInObjectProps(res.data, ["id", "level", "role_id", "career_level", "language_id", "category_id", "ref_id", "job_types", "user", "department", "status"]);

  return res;
};

exports.changeNumberToStringInObjectProps = changeNumberToStringInObjectProps;
exports.changeNumberToStringInArrayProps = changeNumberToStringInArrayProps;
function changeNumberToStringInObjectProps(object) {
...
function changeNumberToStringInArrayProps(array, key, paths) {
